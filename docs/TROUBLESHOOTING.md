# HemoStat Troubleshooting Guide
...
### 2. Monitor Not Detecting Issues
...
### Analyzer Thresholds
```python
# In agents/hemostat_analyzer/hemostat_analyzer.py
...
### Responder Cooldown
```python
# In agents/hemostat_responder/hemostat_responder.py
...
And review the logs carefully for error messages!
